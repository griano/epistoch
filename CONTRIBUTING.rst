...
EpiStoch could always use more documentation, whether as part of the
official EpiStoch docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/griano/epistoch/pull_requests
